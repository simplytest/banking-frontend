Feature: Banking App - RegisterNewCustomer Page
  ...
  Scenario Outline: Validate contact us page
    ...
    And When I click on Registrieren button
    Then I should be presented with a greeting text <greeting>

    Examples:
      | firstName | lastName | password | street    | house | zipCode | city   | country     | email       | birthDate  |
      | John      | Doe      | 123      | Hauptstr. | 1     | 10555   | Berlin | Deutschland | john@doe.de | 2000.01.01 |
